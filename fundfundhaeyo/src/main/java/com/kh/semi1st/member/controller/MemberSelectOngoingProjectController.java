...
/**
 * Servlet implementation class MemberSelectOngoingProjectController
 */
@WebServlet("/ongoingProject.me")
public class MemberSelectOngoingProjectController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberSelectOngoingProjectController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/member/memberOngoingProject.jsp").forward(request, response);
	}
