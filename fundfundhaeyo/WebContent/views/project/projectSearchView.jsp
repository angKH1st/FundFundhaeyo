...
%>
    ...
    <html>
      ...
      <body>
        ...
        <div class="project_search_view_outer">
          <div
            class="project_search_view_main"
            align="center"
						...
						<% }else{ %>
							...
							<br>
								<div class="project_area_head prHoverContainer">
									...
									<% if(loginUser != null) { %>
										<span class="likes" style="position: absolute; bottom: 10px; right: 10px; z-index: 10;" data-projectNo="<%= list.get(0).getProjectNo() %>"><i class="fa-solid fa-heart fa-xl"></i></span>
									<% } %>
								</div>
