		...
		<div class="project_enroll_final_form_main shadow pd15">
			...
			<div class="project_enroll_final_form_main_top">
				<div class="project_enroll_final_form_main_top_left fl brlg br5 pd15">
					<div class="project_enroll_final_left_form">
						<div class="project_enroll_final_left_form_row1">
							<div class="project_enroll_final_title fl">프로젝트 제목</div>
							<div class="project_enroll_final_inspection fl"></div>
						</div>
						<div class="project_enroll_left_final_form_row2 br5">
							<input type="text" placeholder="예시" name="pjTitle" required>
						</div>
					</div>
					<div class="project_enroll_left_final_form">
						<div class="project_enroll_left_final_form_row1">
							<div class="project_enroll_final_title fl">프로젝트 요약</div>
							<div class="project_enroll_final_inspection fl"></div>
						</div>
						<div class="project_enroll_left_final_form_row2 br5">
					...
					<div class="project_enroll_left_final_form">
						<div class="project_enroll_left_final_form_row1">
							<div class="project_enroll_final_title fl">프로젝트 태그</div>
							<div class="project_enroll_final_inspection fl"></div>
						</div>
						<div class="project_enroll_left_final_form_row2 br5">
					...
					<div class="project_enroll_left_final_form">
						<div class="project_enroll_left_final_form_row1">
							<div class="project_enroll_final_title fl">프로젝트 카테고리</div>
							<div class="project_enroll_final_inspection fl"></div>
						</div>
						<div class="project_enroll_left_final_form_row2 br5">
					...
					<div class="project_enroll_left_final_form">
						<div class="project_enroll_left_final_form_row1">
							<div class="project_enroll_final_title fl">프로젝트 내용</div>
							<div class="project_enroll_final_inspection fl"></div>
						</div>
						<div class="project_enroll_left_final_form_row2 br5">
					...
					<br><br>
					<div class="project_enroll_final_title fl" style="width: 49%; height: 7%; margin-right: 8px;">카테고리</div>
					<div class="project_enroll_final_title fl" style="width: 49%; height: 7%;">카테고리</div>
				</div>
				<div class="project_enroll_final_form_main_top_blank fl"></div>
				<div class="project_enroll_final_form_main_top_right fl brlg br5 pd15"></div>
			</div>
			...
			<div class="project_enroll_final_form_main_bottom">
        		...
        		<button type="button" class="project_enroll_final_form_btn2 brlg shadow fl" onclick="location.href='<%= contextPath %>/moveToEnrollFinal.pr'" disabled>다음</button>
			</div>
	    </div>
