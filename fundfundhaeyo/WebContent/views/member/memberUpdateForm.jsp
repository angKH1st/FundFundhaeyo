...
<body>
	...
	<form class="mypage_update_Form_rifht_out form"
			...
			<div class="mypage_update_Form_main shadow brlg br5">
				...
				<div class="mypage_update_Form_right fl">
						...
						<div class="mypage_update_Form_right_info pd15 brlg br5">
							<div class="mypage_update_picture fl">
								<div class="mypage_update_picture_outline brlg br5">
									<div class="mypage_update_picture_org">
										<input type="hidden" name="attachmentOriginNo"
											value="<%=at.getAttachmentNo()%>"> <img
											id="profileImg" src="<%=contextPath%>/<%=userImg%>"
											width="150" height="150" onclick="uploadMemberProfile();">
									</div>
							...
							<div class="mypage_update_etc fl">
								<table class="mypage_update_etc_table">
									...
									<tr>
										<td width=110>아이디</td>
										<td width=150><input type="text" class="bgsb br5"
											name="userId" maxlength="12" value="<%=userId%>" readonly></td>
										<td width=90>전화번호</td>
										<td><input type="text" id="phoneInput" class="bgsb br5"
											name="userPhone" placeholder="- 포함해서 입력" maxlength="13"
											value="<%=userPhone%>"></td>
										<td width=60><button class="phoneBtn br5 blueBtnSmall"
												type="button">변경</button></td>
									</tr>
									<tr>
										<td><br></td>
									</tr>
									<tr>
										<td>이름</td>
										<td><input type="text" class="bgsb br5" name="userName"
											maxlength="10" value="<%=userName%>" readonly></td>
										<td>이메일</td>
										<td><input type="email" id="emailInput" class="bgsb br5"
											name="userEmail" value="<%=userEmail%>"></td>
										<td width=50><button class="emailBtn br5 blueBtnSmall"
												type="button">변경</button></td>
									</tr>
									<tr>
										<td><br></td>
									...
									<tr>
										<td>주민등록번호</td>
										<td><input type="text" class="bgsb br5" name="userSsn"
											maxlength="14" value="<%=userSsn%>" readonly></td>
										<td>주소</td>
										<td><input type="text" id="addressInput" class="bgsb br5"
											name="userAddress" value="<%=userAddress%>"></td>
										<td width=50><button class="addressBtn br5 blueBtnSmall"
												type="button">변경</button></td>
									</tr>
									<tr>
										<td><br></td>
									...
									<tr>
										<td>닉네임</td>
										<td><input type="text" class="bgsb br5"
											name="userNickname" maxlength="10"
											value="<%=userNickname%>"></td>
										<td>마케팅동의</td>
										<td><input type="text" id="marketingInput"
											class="bgsb br5" name="userMarketing" maxlength="1"
											value="<%=userMarketing%>"></td>
										<td width=50><button
												class="marketingBtn br5 blueBtnSmall" type="button">변경</button></td>
									</tr>
									<tr>
										<td><br></td>
									</tr>
									<tr>
										<td>소개말</td>
										<td colspan=3><input type="text" id="profileInput"
											class="bgsb br5" name="userProfile" maxlength="30"
											value="<%=userProfile%>"></td>
										<td width=50><button class="profileBtn br5 blueBtnSmall"
												type="button">변경</button></td>
									</tr>
								</table>
							</div>
					...
					<div class="mypage_update_Form_right_content2 pd15">
						<div class="mypage_update_Form_right_title2">
							<%-- 여백 --%>
						</div>
						<div class="mypage_update_Form_right_btn">
							<button type="submit"
								class="mypage_update_Form_right_submitBtn blueBtn br5">변경</button>
							<button type="button"
								class="mypage_update_Form_right_pwdBtn grayBtn br5"
				...
				<script>
					function validatePwd() { // 유효성 검사!
						if ($("input[name=updatePwd]").val() != $("input[name=checkPwd]").val()) {
							alert("변경할 비밀번호가 일치하지 않습니다.");
							return false; // 일치하지 않으면 값이 가지 않게
						}
					}
				</script>
			</div>
