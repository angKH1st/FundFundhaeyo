...
<meta charset="UTF-8">
<title>뻔뻔해요</title>
<link rel="stylesheet" href="resources/css/memberEnrollAgreementForm.css">
</head>
<body>
	...
	<div class="member_enroll_agreement_form_outer">
		...
		<div class="member_enroll_agreement_form_main">
		    <form id="agreementForm" action="<%= contextPath %>/moveToMemberEnroll.me" method="post" class="signup-form">
