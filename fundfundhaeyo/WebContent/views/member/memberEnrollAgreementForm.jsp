					...
					<div class="enroll_agreement_form_row3">
						...
						<div class="enroll_agreement_form_row3_row2">
							<div style="font-size: 10px">
								제 1 조 목적<br> 본 약관은 주식회사 펀드펀드(이하 “회사”)에서 운영하는 투자형 및 리워드형 펀딩과
					...
					<div class="enroll_agreement_form_row4">
						...
						<div class="enroll_agreement_form_row4_row2">
							<div>
								...
								<br>
								<br> <b>1. 개인정보 수집 이용 보유</b> 펀드펀드는 다음과 같이 개인정보를 수집, 이용하고
								...
								회원 정보 <br>
								<br> <b>2. 개인정보 제3자 제공</b> 펀드펀드는 이용자의 동의가 있거나 관련 법령의 규정에 의한
