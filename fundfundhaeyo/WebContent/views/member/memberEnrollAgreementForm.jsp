					...
					<div class="enroll_agreement_form_row3">
						...
						<div class="enroll_agreement_form_row3_row2">
							<div style="font-size: 10px">
								<b>제 1 조 목적</b><br> 본 약관은 주식회사 펀드펀드(이하 “회사”)에서 운영하는 투자형 및 리워드형 펀딩과
								MOAH 모바일 어플리케이션을 통하여 제공하는 인터넷 관련 제반서비스(이사 “서비스”)의 이용과 관련하여 회사와
								회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다. <br>
								<br><b>제 2 조 용어의 정의</b> <br> 본 약관에서 사용하는 용어의 정의는 다음과 같습니다. <br>
								...
								<br> <b>제 3 조 서비스의 제공</b> <br> 1. 회사는 투자형 펀딩 서비스 (FUNDFUND
								...
								<b>제4조 서비스의 변경</b><br> 회사는 상당한 이유가 있는 경우에 운영상, 기술상의 필요에 따라 제공하고
								...
								<br> <b>제5조 이용계약의 체결</b><br> 회사가 본 약관에 따라 제공하는 서비스를 이용하기
								...
								<br> <b>제 6 조 서비스 이용료</b><br> 회사는 제 3 조에 따른 서비스를 이용하는 회원에 대하여
								...
								<br> <b>제 7 조 회원의 이용계약 해지 등</b><br> 회원은 서비스 중단을 원할 경우 회사가
								...
								있습니다. <br>
								<br> <b>제 8 조 회사의 이용계약의 제한, 해지 등</b><br> 회사는 회원에게 다음 각 호의 해지
								...
								<br> <b>제 9 조 회원정보의 수집과 보호</b> <br> 회사는 서비스 제공을 위하여 이용계약의 체결
								...
								<br> <b>제 10 조 회원의 회원정보 관리에 대한 의무</b><br> 회원의 아이디와 비밀번호를 포함한
								...
								않습니다. <br>
								<br> <b>제 11 조 회원정보의 변경</b><br> 회원은 서비스 내 “회원정보” 화면을 통하여 회원의
								...
								<br> <b>제 14 조 게시물의 관리 등</b><br> 회원이 홈페이지 내에 게시한 게시물의 저작권은 해당
								...
								<br> <b>제 15 조 권리의 귀속</b><br> 서비스에 대한 저작권 및 지적재산권은 회사에 귀속됩니다.
								...
								<br> <b>제 16 조 책임제한</b><br> 개별약관에서 개별 서비스에 관한 회사의 책임범위를 별도로
								...
								지지 않습니다. <br>
								<br> <b>제 17 조 약관의 게시와 개정</b><br> 회사는 본 약관의 내용을 회원이 쉽게 알 수
								...
								<br>
								<br> <b>제 18 조 약관의 효력 및 해석</b><br> 회사는 회사가 제공하는 개별 서비스에 대해서는
								...
								<br> <b>제 19 조 준거법 및 재판관할</b><br> 회사와 회원 간 제기된 소송은 대한민국법을
					...
					<div class="enroll_agreement_form_row4">
						<div class="enroll_agreement_form_row4_row1">
							<div class="enroll_agreement_form_row4_row1_col1 fl">
								<p style="margin-top: 15px;">
									개인정보 수집 및 이용 동의 <span class="required">(필수)</span><br>
								</p>
							</div>
						...
						<div class="enroll_agreement_form_row4_row2">
							<div>
								본 개인정보 처리방침은 주식회사 펀드펀드(이하 “펀드펀드”라고 합니다)에서 제공하는 모든 서비스 이용에 적용됩니다.
								<br> 펀드펀드는 귀하의 개인정보보호를 매우 중요시하며, 개인정보보호법, 정보통신망이용 촉진 및
								정보보호등에 관한 법률 또는 관련법령, 규정을 준수하고 있습니다.<br> '개인정보 처리방침'이란 이용자의
								소중한 개인정보를 보호함으로써 이용자가 안심하고 서비스를 이용할 수 있도록 회사가 준수해야 할 지침을 의미합니다.'<br>
							
								<br> <b>1. 개인정보 수집 이용 보유</b><br> 펀드펀드는 다음과 같이 개인정보를 수집, 이용하고
								...
								회원 정보 <br>
								<br> <b>2. 개인정보 제3자 제공</b><br> 펀드펀드는 이용자의 동의가 있거나 관련 법령의 규정에 의한
								경우, 또는 펀드펀드가 이용자에게 제공하는 서비스 및 상품의 공급을 위하여 필요한 경우를 제외하고는 본 개인정보
								...
								등에 대해 개인정보처리방침 및 홈페이지 등을 통해 고지한 후 동의를 구합니다. <br> 이용자는 펀드펀드가
								사용자의 개인정보를 이용하거나 제3자에게 제공·공유한 내역을 요구할 권리가 있으며, 필요 시에 펀드펀드의
								...
								제공하는 경우 <br>
								<br> <b>3. 수집한 개인정보 취급 위탁</b><br> 펀드펀드는 서비스 향상 및 원활한
								계약사항의 이행 등을 위하여 개인정보 처리업무를 외부에 일부 위탁하고 있습니다. <br> 펀드펀드는
								이용자의 개인정보를 외부에 위탁하는 경우에 사전에 이용자에게 위탁 받는 자, 목적, 위탁되는 개인정보항목 등에 대해
								개인정보 처리방침에 고지한 후 이에 대한 동의를 구합니다. <br>
								<br> <b>4. 장기 미이용 개인정보 분리 보관</b><br> 펀드펀드는
								관련법령(정보통신망이용촉진및정보보호등에관한법률 제29조 및 동법 시행령 제16조)에 의거하여 장기 미이용 회원을
								휴면회원으로 계정 전환하고, 개인정보를 암호화하여 분리 보관합니다. 펀드펀드는, 서비스를 1년 이상 이용하지 않아
								...
								전환 예정일 이전에 펀드펀드에 로그인 하시는 경우 휴면 상태로 전환되지 않고 기존과 동일하게 서비스를 이용하실 수
								있습니다.<br> 4-2. 휴면 회원 개인정보 보관 기간<br> 휴면 회원의 개인정보는 4년 간
								별도 분리 보관 후, 삭제됩니다. <br> 4-3. 휴면 회원의 계정 활성화 방법<br> 계정이
								휴면 상태로 이미 전환된 회원은 기존에 펀드펀드 사이트 상에서 사용했던 ID와 비밀번호로 로그인하여 서비스를
								재이용함으로써, 일반회원으로 전환될 수 있습니다. <br> 4-4. 휴면 상태 전환의 예외(권익보호의
								목적)<br> 가. 펀드펀드 사이트 내 본인의 투자예치금계좌(가상계좌)에 예치금이 남아있는 회원 <br>
								나. 펀드펀드 리워드 프로젝트에 참여하여 서비스를 제공받고 있는 회원 <br> 다. 펀드펀드 투자
								프로젝트에 참여하여 서비스를 제공받고 있는 회원 <br>
								<br> <b>5. 개인정보 파기</b><br> 5-1. 파기절차 <br> 수집∙이용목적이 달성된
								...
								분쇄하거나 소각을 통하여 파기<br>
								<br> <b>6. 이용자의 권리</b><br> 펀드펀드 이용자 본인 및 법정대리인은 언제든지
								수집 정보에 대해 수정, 동의, 삭제, 열람 등을 요청할 수 있습니다. 다만 동의 철회, 삭제 시 서비스의 일부
								또는 전부 이용이 제한될 수 있습니다. <br> 6-1. 개인정보 열람<br> 펀드펀드에서
								...
								6-2. 개인정보 수정<br> 펀드펀드 서비스 내 ‘마이페이지’를 통한 직접 수정 또는 펀드펀드에 문의를
								통해 수정을 요청할 수 있고, 이 과정에서 수정을 위한 본인확인 등의 절차가 진행될 수 있습니다.<br>

								6-3. 개인정보 제공 동의 철회 및 삭제<br> 펀드펀드 서비스 내에서 이용자 본인이 직접
								회원탈퇴(마이페이지-설정-회원탈퇴)를 하거나 펀드펀드에 문의를 통해 수집된 정보에 대한 제공 동의를 철회하거나
								삭제를 요청할 수 있습니다. 다만, 이런 요청 시 서비스의 일부 또는 전체 이용이 제한될 수 있으며 다른 법령에
								따라 수집하는 정보의 경우에는 동의 철회, 삭제가 어려울 수 있습니다.<br><br> <b>7. 이용자의
									의무</b><br> 이용자 본인은 자신의 개인정보를 보호할 의무가 있습니다. 펀드펀드의 귀책사유 없이
								ID(이메일), 비밀번호, 접근매체 등의 양도∙대여∙분실이나 로그인 상태에서 이석 등 본인의 부주의, 또는
								관계법령에 의한 보안조치로 차단할 수 없는 방법이나 기술을 사용한 해킹 등 펀드펀드가 통제할 수 없는 인터넷상의
								문제 등으로 개인정보가 유출되어 발생한 문제에 대해서 펀드펀드는 책임을 지지 않습니다.<br>
								...
								<br> <b>9. 링크 사이트에 대한 책임</b><br> 펀드펀드는 이용자에게 다른 회사의
								웹사이트 또는 자료에 대한 링크를 제공할 수 있습니다. 이 경우 펀드펀드는 외부 사이트 및 자료에 대한 아무런
								통제권이 없으므로 그로부터 제공받는 서비스나 자료의 유용성에 대해 책임질 수 없으며 보증할 수 없습니다. 펀드펀드
								서비스 내 링크를 클릭하여 타 사이트의 페이지로 옮겨갈 경우, 해당 사이트의 개인정보 처리방침은 펀드펀드와
								...
								<br> <b>11. 개인정보 관리 책임자</b><br> 펀드펀드는 개인정보 처리에 관한 업무를
								총괄해서 책임지고, 개인정보 처리와 관련한 이용자의 불만 처리 및 피해 구제등을 위하여 아래와 같이 개인정보 관리
								책임자를 지정하고 있습니다. 또한 펀드펀드를 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만 처리, 피해
