...
<body>
	...
	<div class="mypage_likes_Form_outer">
			...
			<div class="mypage_likes_Form_main shadow brlg br5">
				...
				<div class="mypage_likes_Form_right fl">
					<div class="mypage_likes_Form_right_content1 pd15">
						...
						<div class="mypage_likes_Form_right_title"><h3>제목</h3></div>
						<div class="mypage_likes_Form_right_TBD brlg br5">TBD 클래스이름 고쳐야함</div>
					</div>
					<div class="mypage_likes_Form_right_content2 pd15">
						<div class="mypage_likes_Form_right_title2"><h3>제목</h3></div>
						<div class="mypage_likes_Form_right_TBD2 brlg br5">TBD 클래스이름 고쳐야함</div>
					</div>
				</div>
			</div>
