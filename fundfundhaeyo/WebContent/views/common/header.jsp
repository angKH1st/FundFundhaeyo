                ...
                <div class="ffh_header_center fl">
                    <div class="ffh_header_center2">
                        ...
                        <div class="ffh_header_center_right fl">
                            ...
                            <div class="ffh_header_center_right4 fl"><a href="<%= contextPath %>/moveToMemberNotices.no?cpage=1&type=1" class="heada"><i class="fa-regular fa-bell fa-xl" style="line-height: 150%;"></i></a></div>
