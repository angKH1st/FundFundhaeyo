    ...
    <div id="modal1" class="modal">
        <div class="modal_body">
            ...
            <p><h1>뻔뻔해요 이용약관</h1> <br><br>
                ...
                <h2>3. 회원정보의 보호 및 관리</h2> <br><br>
                <h3>제 4조 개인정보보호 및 의무</h3>
                <ul>
                    <li>개인정보 수집 및 이용 동의: 회원정보를 수집할 때는 해당 정보의 수집 목적과 이용 방법을 명확히 알려주고, <br> 회원들로부터 동의를 받아야 합니다. 이는 개인정보보호법 등 관련 법령에서 규정하는 내용입니다.</li><br>
                    <li>보안 조치: 회원정보를 안전하게 보호하기 위해 보안 시스템을 구축하고 유지해야 합니다. <br> 이는 데이터 암호화, 접근 제어, 네트워크 보안 등 다양한 보안 조치를 포함합니다.</li><br>
                    <li>접근 제한: 회원정보에 접근할 수 있는 권한을 제한하고, 필요한 경우 접근 로그를 기록하여 <br> 누가 언제 해당 정보에 접근했는지 추적할 수 있도록 해야 합니다.</li><br>
                    <li>개인정보 침해 대응: 개인정보가 침해되거나 유출된 경우에는 즉시 대응 조치를 취해야 합니다. <br> 이는 회원들에게 공지하고 관련 당국에 신고하는 등의 조치를 포함합니다.</li>
                </ul> <br>

                <h2>4. 기타</h2> <br><br>
                <h3>제 5조 회사의 의무</h3>
                <ul>
                    <li>법적 의무: 회사는 관련 법규와 규정을 준수해야 합니다. 이는 국가의 법률, 세금법, 노동법, 소비자 <br> 보호법 등 다양한 법적 규정을 포함합니다. 회사는 이러한 법적 의무를 준수하고, 법적 요구를 충족 <br> 시켜야 합니다.</li> <br>
                    <li>고객 서비스 의무: 회사는 고객에게 제품이나 서비스를 제공함으로써 고객에 대한  의무를 가집니다. <br> 이는 고객의 요구를 듣고 이에 대한 적절한 대응을 해야 하며, 제품 또는 서비스의 품질을 유지하고 <br> 개선해야 합니다.</li> <br>
                    <li>직원 관리 및 복지 의무: 회사는 직원들의 권리를 보호하고 그들의 복지를 증진시키는 의무를 가집 <br> 니다. 이는 적절한 임금을 지급하고 안전한 작업 환경을 제공하는 것부터 시작하여, 직원들의 교육 <br> 과 훈련, 직업 발전 기회를 제공하는 것까지 포함됩니다.</li> <br>
                    <li>사회적 책임: 회사는 사회적 책임을 갖습니다. 이는 환경 보호, 지역 사회 발전, 사회적 기여 등 다양 <br> 한 방식으로 나타날 수 있습니다. 회사는 사회적 책임을 이행하기 위해 사회 활동에 참여하고, 지속 <br> 가능한 경영과 사회적 가치 창출을 추구해야 합니다.</li> <br>
                    <li>정보 공개 의무: 회사는 투자자, 고객, 규제 기관 등과의 관계에서 정보를 적시에 공개하고 투명하게 <br> 의사 소통해야 합니다. 이는 재무 보고서, 사업 계획서, 제품 정보 등 다양한 정보를 포함합니다.</li> <br>
                    <li>품질 보증 의무: 회사는 제품 <br> 이나 서비스의 품질을 보장해야 합니다. 이는 고객에게 효과적인 제품이나 서비스를 제공하고, 만족스러운 사용자 경험을 제공하는 것을 의미합니다.</li>
                </ul> <br>

                <h3>제 6조 회원의 의무</h3>
                <ul>
                    <li>규칙 및 정책 준수: 회원은 해당 조직이나 시스템의 규칙과 정책을 준수해야 합니다. 이는 서비스 이 <br> 용 방법, 행동 강령, 커뮤니티 가이드라인 등을 포함합니다.</li> <br>
                    <li>정보 제공 및 업데이트: 회원은 필요한 경우 자신의 정보를 정확하게 제공하고 업데이트해야 합니 <br> 다. 특히, 연락처 정보나 계정 관련 정보가 변경될 경우 이를 즉시 업데이트해야 합니다.</li> <br>
                    <li>비밀번호 보호 및 계정 안전: 회원은 자신의 계정을 안전하게 보호해야 합니다. 이는 안전한 비밀번 <br> 호를 설정하고 비밀번호를 절대 타인에게 노출하지 않아야 한다는 것을 의미합니다.</li> <br>
                    <li>사용자 콘텐츠의 적법한 이용: 회원이 시스템에 업로드하거나 게시한 콘텐츠는 저작권 등 관련 법률 <br> 을 준수해야 합니다. 불법적인 콘텐츠의 게시는 금지되며, 타인의 권리를 침해해서도 안 됩니다.</li> <br>
                    <li>존중과 예의: 회원은 다른 회원들을 존중하고 상호 예의를 지켜야 합니다. 혐오표현, 욕설, 모욕적인 <br> 언어를 사용하는 것은 금지되며, 다른 회원들의 권리와 의견을 존중해야 합니다.</li> <br>
                    <li>서비스 이용의 적법성: 회원은 서비스를 적법하게 이용해야 합니다. 이는 서비스를 악용하거나 <br> 다른 회원들에게 피해를 주는 행위를 하지 않아야 한다는 것을 의미합니다.</li> <br>
                    <li>지적재산권 보호: 회원은 타인의 지적재산권을 존중하고 보호해야 합니다. 불법적인 소프트웨어 사 <br> 용, 저작권 침해, 상표권 침해 등은 금지되며, 회원은 이를 준수해야 합니다.</li>
                </ul>
